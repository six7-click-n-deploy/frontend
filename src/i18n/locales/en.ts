export default {
  ...
  DeploymentDetailView: {
    ...
    destroyDeployment: "Destroy Resources",
    confirmDestroyTitle: "Confirm Destroy",
    confirmDestroyMessage: "Are you sure you want to destroy all Terraform resources for deployment <strong>{name}</strong>? This cannot be undone.",
    confirmDestroyButton: "Start Destroy",
    destroySuccessToast: "Destroy started successfully.",
